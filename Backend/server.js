...
const allowedOrigins = [
    'http://56.228.31.104:8051', // Frontend
    'http://56.228.31.104:8052', // HR Page
    'http://56.228.31.104:3427', // Backend
    'http://localhost:3019',
    'http://127.0.0.1:5501',
    'http://127.0.0.1:5503'
];
...
async function startServer() {
    try {
        ...
        app.listen(port, '0.0.0.0', () => {
            ...
            console.log(`Health check: http://56.228.31.104:${port}/health`);
            console.log(`HR Dashboard: http://56.228.31.104:${port}/attendance.html`);
            console.log(`Employee Attendance: http://56.228.31.104:${port}/employee_attendance.html`);
        });
    } catch (err) {
